...
public Pane shape(parent p) throws IOException{
        ...
        sup.setOnAction(new EventHandler<ActionEvent>() {
            ...
            alert.setContentText("Voulez vous supprimer cette parent?");
        ...
        mod.setOnAction(new EventHandler<ActionEvent>() {
            ...
            alert.setTitle("Confirmation Message");
            alert.setHeaderText(null);
            alert.setContentText("Voulez vous modifier cette parent?");
            ...
            if (buttonType.get() == ButtonType.OK) {
                ...
                serviceparent sp =new serviceparent();
                parent c=new parent(p.getId_parent(),prenom.getText(),nom.getText(),email.getText(),login.getText());
                sp.modifier(c);
